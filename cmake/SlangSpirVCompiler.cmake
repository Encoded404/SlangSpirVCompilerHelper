...
function(add_slang_shaders)
    ...
    if(ARG_OPT_LEVEL)
        if(NOT ARG_OPT_LEVEL MATCHES "^[0-3]$" AND NOT ARG_OPT_LEVEL MATCHES "\\$<")
            message(FATAL_ERROR "add_slang_shaders: OPT_LEVEL must be 0, 1, 2, 3, or a generator expression (got '${ARG_OPT_LEVEL}')")
        endif()
    endif()
